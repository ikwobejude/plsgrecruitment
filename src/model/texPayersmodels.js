...
const vehicle_models = db.define('vehicle_models', {
    vehicle_model_id: {
        type: Sequelize.BIGINT(11),
        primaryKey: true,
        autoIncrement: true,
    ...
    vehicle_model: { type: Sequelize.STRING(100) },
    vehicle_make: { type: Sequelize.STRING(100) },
}, {
    timestamps: false,
    freezeTableName: true
})

const vehicle_makes = db.define('vehicle_makes', {
    vehicle_make_id: {
        type: Sequelize.BIGINT(11),
        primaryKey: true,
        autoIncrement: true,
...
const vehicle_colors = db.define('vehicle_colors', {
    vehicle_color_id: {
        type: Sequelize.BIGINT(11),
        primaryKey: true,
        autoIncrement: true,
    ...
    color: { type: Sequelize.STRING(100) },
}, {
    timestamps: false,
    freezeTableName: true
})
