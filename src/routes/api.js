...
const { GetVehicleModel } = require("../controllers/adminController");
const { reportDash } = require("../controllers/receptController");
...
api.get('/vehicle_model', async(req, res) => {
  GetVehicleModel(req, res)
})

api.get('/_reports', async(req, res) => {
  reportDash(req, res)
})
